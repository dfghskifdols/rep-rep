...
ALLOWED_USERS = [5283100992, 5222780613, 5344318601, 1552417677, 1385118926, 6139706645]  # Список пользователей, которым разрешено отправлять сообщения
...
rafu_responses = [
    ...
    "#Хаюш#Бой.#твикат#Not Хочет умереть от своей души",
    "Бомбабот на самом деле не бот🙈",
    "О пушочке: 11 лет, гей, ищет жену",
    "жду",
    "Тихий_Сон пытается найти мираж остров и на нем шестеренку для в4 рас в блокс фрукт",
