...
ALLOWED_USERS = [5283100992, 6340673182, 5344318601, 1552417677]  # Список пользователей, которым разрешено отправлять сообщения
...
rafa_responses = [
    ...
    "Vipsi - долбаеб", "Vipsi слишком глупый", "Третий факт про себя Vipsi забыл"
]
